...
public class LoginViewHelper {
	...
	public String generateLoginParameters(String username, String password,
			String usergroup) {
	...
	public String generateLoginSuccess(String username, String password,
			String usergroup) {
		StringBuilder html = new StringBuilder();
		html.append("<html>");
		html.append("  <head>");
	...
	public String generateLoginRejected(String username, String password,
			String usergroup) {
		StringBuilder html = new StringBuilder();
		html.append("<html>");
		html.append("  <head>");
